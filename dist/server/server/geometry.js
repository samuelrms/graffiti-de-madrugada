import { MAX_SPEED, SPEED_SLACK } from "./config.js";
/** Buildings whose footprint (expanded by `pad`) contains (x, z). */
export function buildingsAt(buildings, x, z, pad) {
...
export function movementViolation(buildings, me, x, y, z, dt, now) {
